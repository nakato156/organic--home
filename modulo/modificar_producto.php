...
if (isset($modif)) {
	...
	mysqli_query($mysqli,"UPDATE productos SET name = '$name',precio = '$precio', id_categoria = '$categoria', oferta = '$oferta' WHERE id = '$idpro'");
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<input type="text" class="form-control" name="precio" value="<?=$rq['precio']?>" placeholder="Precio del producto"/>
	</div>
	...
	<div class="form-group">
		<select name="oferta" class="form-control">
			...
			<option <?php if($rq['oferta'] == 45){echo "selected";}?> value="35">35% de Descuento</option>
	...
	<div class="form-group">
		<button type="submit" class="icon-check" name="modif">Modificar producto producto</button>
	</div>
